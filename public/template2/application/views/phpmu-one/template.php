...
<footer style='background:#336699; color:#ffffff; border-top:1px solid #ffffff'>
  <div class="container">
      <div class="row">
          <div class="col-sm-12">
              <center>
                <small class='text-footer'>Copyright &copy;2020 - <b><?php echo $iden['nama_website']; ?></b> - My Coding <br>
