...
<head>
    ...
    <title>Linker | Daftar Perusahaan</title>
</head>
            ...
            <div class="col-lg-6 col-md-6 infinity-form-container">
                <div class="col-lg-9 col-md-12 col-sm-8 col-xs-12 infinity-form">
                    ...
                    <div class="text-center mb-3 mt-5">
                        <img src="/img/imgper/avtr1.png" width="150px">
                    </div>
                    <div class="text-center mb-4">
                        <h4 class="title text-secondary" style="font-size: 33px;">Daftar Akun Perusahaan</h4>
                    </div>
                    ...
                    <!-- Form -->
                    <?php echo form_open('auth/save_register_perusahaan', 'class="form-box px-3"'); ?>
                    <div class="form-input">
                        <span><i class="fas fa-user"></i></span>
                        <input type="text" name="nama_per" placeholder="Nama Perusahaan" required>
                    </div>
                    <div class="form-input">
                    ...
                    <div class="text-center mb-2">
                        Sudah punya akun?
                        <a href="<?= base_url('auth/login_perusahaan') ?>" class="register-link">
                            Masuk disini
                        </a>
                    </div>
                    <?php form_close(); ?>
