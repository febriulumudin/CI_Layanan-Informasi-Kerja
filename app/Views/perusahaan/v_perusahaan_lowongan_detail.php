                ...
                <div class="row pt-3">
                    <div class="col-12">
                        <div class="row pl-3 pt-2 pb-3">
                            ...
                            <div class="col-3 text-center" style="padding-top: 40px !important;">
                                ...
                                if ($value['status_lowongan'] == 'y') { ?>
                                    <a href="#" class="btn btn-primary btn-md" style="white-space: normal;" data-toggle="modal" data-target="#modallowonganstatus<?= $value['id_lowongan'] ?>">
                                        Aktif
                                    </a>
                                <?php } else { ?>
                                    <a href="#" class="btn btn-danger btn-md" style="white-space: normal;" data-toggle="modal" data-target="#modallowonganstatus<?= $value['id_lowongan'] ?>">
                                        Non-Aktif
                                    </a>
                                <?php } ?>
                            </div>
                        ...
                        <div class="card-body mt-1">
                                ...
                                <div class="col-7">
                                    <div>
                                        ...
                                        <?php foreach ($lowonganlain as $key => $valuelain) : ?>
                                            <a href="/user_perusahaan/lowongan_detail/<?= $valuelain["id_lowongan"] ?>/<?= $valuelain["id_perusahaan"] ?>/<?= session()->get('id_user') ?>">
                            ...
                            <div class="row">
                                <div class="col">
                                    <a href="/user_perusahaan/perusahaan_detail/<?= $value["id_perusahaan"] ?>" class="btn btn-primary btn-lg" style="width: 100%;">
...
<?php foreach ($lowongan as $key => $value) { ?>
    <div class="modal fade" id="modallowonganstatus<?= $value['id_lowongan'] ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-info">
                    <h4 class="modal-titlet" style="font-weight: bold; color: white;">Ubah Data</h4>
                ...
                ?>
                <?php echo form_open('user_perusahaan/ubahstatus/' . $value['id_lowongan'] . '/' . $value['id_perusahaan']) ?>
                <div class="modal-body">
                    Apakah Anda Yakin Ingin Mengubah Status Lowongan Menjadi Akun <strong><?= $status ?></strong>
                    <div class="form-group" style="margin-top: -40px;">
                        <input type="text" name="status" value="<?= $stts ?>" class="form-control hidden" style="visibility: hidden;">
                    </div>
                </div>
