<div class="content">
    ...
    <div class="page-inner mt--5">
        ...
        <div class="row justify-content-center">
            <div class="col-xs-12">
                <a href="/lowongan/daftar_lowongan" class="btn btn-primary">
                    <span class="btn-label">
        ...
        <div class="row justify-content-center">
            <div class="col-xs-12">
                <a href="/perusahaan" class="btn btn-primary">
                    <span class="btn-label">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer" style="display: inline-block !important;">
                    ...
                    <a href="/lowongan/lowongan_detail/<?= $value["id_lowongan"] ?>/<?= $value["id_perusahaan"] ?>/<?= session()->get('id_user') ?>" class="btn btn-success float-right">Lanjut</a>
